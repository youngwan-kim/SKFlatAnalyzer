...
TString filename = "/data6/Users/jihkim/SKFlatOutput/Run2Legacy_v4/ChargeFlip/2016/CFrate__200__/ChargeFlip_All_200.root";
...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  //TGraph* gr1 = new TGraphErrors(X_1.size(),&X_1[0],&Y_1[0],&EX_1[0],&EY_1[0]);
  TGraph* gr1 = new TGraphErrors(X_1.size(),&X_1[0],&Y_1[0]);
  ...
  //TF1 *gr1_fit2 = new TF1("gr1_fit2","pol1",0.005,0.01);
  //TF1 *gr1_fit2 = new TF1("gr1_fit2","[0]/(x+[1])+[2]",0.005,0.016);
  TF1 *gr1_fit2 = new TF1("gr1_fit2","expo",0.005,0.011);
  //TF1 *gr1_fit2 = new TF1("gr1_fit2","pol2",0.004,0.0155);
  TF1 *gr1_fit3 = new TF1("gr1_fit3","pol1",0.011,0.041);
  ...
  for(int i=0; i<9; i++) gr1_fit2_err->SetPoint(i,0.004+0.001*i,0);
  (TVirtualFitter::GetFitter())->GetConfidenceIntervals(gr1_fit2_err);
  gr1_fit2_err->SetFillColor(7);
  ...
  TGraphErrors* gr2 = new TGraphErrors(X_2.size(),&X_2[0],&Y_2[0]);
  ...
  TF1 *gr2_fit1 = new TF1("gr2_fit1","pol1",0,0.005);
  //TF1 *gr2_fit2 = new TF1("gr2_fit2","pol1",0.004,0.02);
  //TF1 *gr2_fit2 = new TF1("gr2_fit2","[0]/(x+[1])+[2]",0.005,0.015);
  TF1 *gr2_fit2 = new TF1("gr2_fit2","expo",0.005,0.015);
  //TF1 *gr2_fit2 = new TF1("gr2_fit2","pol2",0.005,0.01);
  ...
  TGraphErrors *gr2_fit1_err = new TGraphErrors(5);
  for(int i=0; i<5; i++) gr2_fit1_err->SetPoint(i,0.001*i,0);
  ...
  TGraphErrors *gr2_fit2_err = new TGraphErrors(17);
  for(int i=0; i<17; i++) gr2_fit2_err->SetPoint(i,0.004+0.001*i,0);
  ...
  TGraphErrors *gr2_fit3_err = new TGraphErrors(21);
  for(int i=0; i<21; i++) gr2_fit3_err->SetPoint(i,0.02+0.001*i,0);
  ...
  TGraphErrors* gr3 = new TGraphErrors(X_3.size(),&X_3[0],&Y_3[0]);
  ...
  TF1 *gr3_fit1 = new TF1("gr3_fit1","pol1",0,0.005);
  //TF1 *gr3_fit2 = new TF1("gr3_fit2","pol1",0.004,0.021);
  TF1 *gr3_fit2 = new TF1("gr3_fit2","[0]/(x+[1])+[2]",0.005,0.026);
  //TF1 *gr3_fit2 = new TF1("gr3_fit2","expo",0.005,0.021);
  //TF1 *gr3_fit2 = new TF1("gr3_fit2","pol2",0.005,0.021);
  TF1 *gr3_fit3 = new TF1("gr3_fit3","pol1",0.026,0.04);
  ...
  TGraphErrors *gr3_fit2_err = new TGraphErrors(18);
  for(int i=0; i<18; i++) gr3_fit2_err->SetPoint(i,0.004+0.001*i,0);
  ...
  TGraphErrors *gr3_fit3_err = new TGraphErrors(21);
  for(int i=0; i<21; i++) gr3_fit3_err->SetPoint(i,0.02+0.001*i,0);
