...
TString filename = "/data9/Users/youngwan/SKFlatOutput/Run2UltraLegacy_v3/ChargeFlip/2018/CFrate__/ChargeFlip_All.root";
...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  vector<double> gr1_range = {0, 0.002, 0.025, 0.04}; // 0, 0.002, 0.011, 0.04
  ...
  vector<double> gr2_range = {0, 0.002, 0.035, 0.04 }; // 0, 0.002, 0.035, 0.04 or 0, 0.005, 0.022, 0.04
...
*/
  ...
  if(save == "y"){
    if(zoom == "y"){
      ...
      c1->SaveAs(fitIB+"_EtaRegion1.png");
      c2->SaveAs(fitOB+"_EtaRegion2.png");
      c3->SaveAs(fitEC+"_EtaRegion3.png");
    }
  }
