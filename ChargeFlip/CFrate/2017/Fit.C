void Fit(TString fitIB = "expo_invx", TString fitOB = "expo_invx", TString fitEC = "invx_only", TString scan = "n", TString zoom = "n", TString save = "y"){
TString filename = "/data9/Users/youngwan/SKFlatOutput/Run2UltraLegacy_v3/ChargeFlip/2017/CFrate__/ChargeFlip_All.root";
...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  vector<double> gr1_range =  {0, 0.005, 0.022, 0.04};
  ...
  vector<double> gr2_range =  {0, 0.003, 0.027, 0.04};
  ...
  gr3_fit1->SetParameters(1.62402e-05,-6.70064e-04,1.76648e-04);
  gr3->Fit(gr3_fit1,"RM");
...
*/
  ...
  if(save == "y"){
    if(zoom == "y"){
      c1->SaveAs(fitIB+"_Zoom_EtaRegion1.png");
      c2->SaveAs(fitOB+"_Zoom_EtaRegion2.png");
      c3->SaveAs(fitEC+"_Zoom_EtaRegion3.png");
    }
    else{
      c1->SaveAs(fitIB+"_EtaRegion1_test.png");
      c2->SaveAs(fitOB+"_EtaRegion2_test.png");
      c3->SaveAs(fitEC+"_EtaRegion3_test.png");
    }
  }
