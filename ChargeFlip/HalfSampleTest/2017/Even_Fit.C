...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  vector<double> gr1_range = {0, 0.003, 0.020, 0.04};
  ...
  vector<double> gr2_range = {0, 0.002, 0.017, 0.04};
  ...
  if(scan == "y"){
    ...
    for(int i=0; i<how_many; i++){
      ...
      vector<double> opts23 = {0.020, 0.017, 0.015}; // to check opt results by eyes
