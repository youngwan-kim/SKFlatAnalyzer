...
for channel in channels:
  ...
  fileTruth  = rt.TFile("/home/youngwan/data9/SKFlatOutput/Run2UltraLegacy_v2/ChargeFlip/2016postVFP/ScaleFactor__/ChargeFlip_"+fileName+".root",'read')
  ...
  elif fileTruth.GetName() == "ChargeFlip_DYJets_All.root" and channel == "EE":
    pars = [
        "meanOS[-0.0,-5.0,5.0]","sigmaOS[0.9,0.5,5.0]",
        "meanSS[-0.0,-5.0,5.0]","sigmaSS[0.9,0.5,5.0]",
  ...
  infile = rt.TFile("/home/youngwan/data9/SKFlatOutput/Run2UltraLegacy_v2/ChargeFlip/2016postVFP/ScaleFactor__/DATA/ChargeFlip_DoubleEG.root", "read")
  if channel == "BE":
