...
for channel in channels:
  ...
  if channel == "BE":
    hOS = infile.Get("HNTightV1/ScaleFactor/"+channel+"_ZMass_OS_MET50")
  else:
    hOS = infile.Get("HNTightV1/ScaleFactor/"+channel+"_ZMass_OS_MET50")
  hSS = infile.Get("HNTightV1/ScaleFactor/"+channel+"_ZMass_SS_MET50")
  fitter = tnpFitter( hOS, hSS, fileName, "myhist_MET50_"+channel )
  infile.Close()
  ...
  if channel == "BE":
    histZLineShapeOS = fileTruth.Get("HNTightV1/ScaleFactor/"+channel+"_ZMass_OS_MET50")
  else:
    histZLineShapeOS = fileTruth.Get("HNTightV1/ScaleFactor/"+channel+"_ZMass_OS_MET50")
  histZLineShapeSS = fileTruth.Get("HNTightV1/ScaleFactor/"+channel+"_ZMass_SS_MET50")
