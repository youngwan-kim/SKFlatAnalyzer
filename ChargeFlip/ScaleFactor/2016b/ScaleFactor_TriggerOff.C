...
void ScaleFactor(TString id, TString EtaRegion, int Syst = 0, TString SaveAs = "n"){ // BB, BE, EE
  ...
  TString filename = "/data6/Users/jihkim/SKFlatOutput/Run2Legacy_v3/ChargeFlip/2016/ScaleFactor__TriggerOff__/DATA/ChargeFlip_DoubleEG_total_TriggerOff_DYTTLLCF.root";
