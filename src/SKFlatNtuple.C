...
void SKFlatNtuple::Init()
{
  ...
  fChain->SetMakeClass(1);
   ...
   fChain->SetBranchAddress("pfMET_Px_shifts", &pfMET_Px_shifts, &b_pfMET_Px_shifts);
   fChain->SetBranchAddress("pfMET_Py_shifts", &pfMET_Py_shifts, &b_pfMET_Py_shifts);
   ...
   fChain->SetBranchAddress("pfMET_Type1_Px_shifts", &pfMET_Type1_Px_shifts, &b_pfMET_Type1_Px_shifts);
   fChain->SetBranchAddress("pfMET_Type1_Py_shifts", &pfMET_Type1_Py_shifts, &b_pfMET_Type1_Py_shifts);
   ...
   fChain->SetBranchAddress("pfMET_Type1_PhiCor_Px_shifts", &pfMET_Type1_PhiCor_Px_shifts, &b_pfMET_Type1_PhiCor_Px_shifts);
   fChain->SetBranchAddress("pfMET_Type1_PhiCor_Py_shifts", &pfMET_Type1_PhiCor_Py_shifts, &b_pfMET_Type1_PhiCor_Py_shifts);
