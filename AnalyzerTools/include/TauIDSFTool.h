...
class TauIDSFTool {
  ...
  public:
    ...
    TauIDSFTool(const std::string& year, const std::string& id="MVAoldDM2017v2", const std::string& wp="Tight", const std::string& wp_vsele="VVLoose",
                const bool dm=false, const bool ptdm=false, const bool embedding=false, const bool highpT=false);
    ~TauIDSFTool() { }
